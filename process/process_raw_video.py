...
def process_frame(q1,align=True,scale=1.8,size=512):
    ...
    lmk_detector = face_alignment.FaceAlignment(face_alignment.LandmarksType._3D, flip_input=False,device=device)
    kk = 1
        ...
        for k,info_name in enumerate(info_names):
            ...
            for (i,x,y,w,h) in info:
                try:
                    ...
                    image_cropped,_ = crop_with_padding(img,landmarks[:,:2],bbox,scale=scale,size=size,align=align)
